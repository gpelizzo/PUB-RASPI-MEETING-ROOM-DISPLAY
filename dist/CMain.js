...
var TIMER_REGISTER_TO_SERVER = 15000;
...
var UDP_DISPLAY_SETTINGS = 'DISPLAY_CONFIG'; //display settings
var UDP_DISPLAY_MEETINGS = 'DISPLAY_MEETINGS'; //display meetings
...
var CMain = /** @class */ (function () {
    ...
    */
    CMain.run = function () {
        ...
        */
        this.mExpressModule.post('/reboot', function (req, res) {
            res.send('ok');
            exec('shutdown -r now');
        });
