...
const TIMER_REGISTER_TO_SERVER = 15000;
...
const UDP_DISPLAY_SETTINGS = 'DISPLAY_CONFIG';		//display settings
const UDP_DISPLAY_MEETINGS = 'DISPLAY_MEETINGS';	//display meetings
...
export class CMain {
	...
	*/
	public static run() {
		...
		*/
		this.mExpressModule.post('/reboot', (req: any, res: any) => {
			res.send('ok');
			exec('shutdown -r now');
		});
